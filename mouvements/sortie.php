...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Vérifier si suffisamment de stock disponible
    if (!empty($produitId) && $quantite > 0) {
        $product = getProductById($db, $produitId);
        if ($product && $product['quantite'] < $quantite) {
            $errors[] = "Quantité insuffisante en stock. Disponible: {$product['quantite']}";
        }
    }
    ...
    if (empty($errors)) {
        try {
            ...
            header("Location: ../suivi_stock/index.php?success=exit_added");
            exit;
        } catch (Exception $e) {
...
<head>
    ...
    <title>Sortie de Stock - Gestion de Stocks</title>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="" onsubmit="return window.formFunctions.validateMovementForm()">
                        <input type="hidden" id="type" name="type" value="exit">
                        ...
                        <div class="form-group">
                            ...
                            <select id="product" name="product" class="form-control" required>
                                ...
                                <?php foreach ($products as $product): ?>
                                    <?php if ($product['quantite'] > 0): // N'afficher que les produits ayant du stock ?>
                        ...
                        <div class="form-group">
                            <label for="comment">Destination ou motif (vente, transfert, etc.)</label>
